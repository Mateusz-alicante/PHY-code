...
class exp():
    ...
    def calc_vol(self, pressure_sampling_time = 100, temperature_sampling_time = 100, pressure_sampling_start = 0, temperature_sampling_start = 0):
        ...
        Pi = ufloat(statistics.mean(self.data["P1"][pressure_sampling_start:(pressure_sampling_start + pressure_sampling_time)]), self.errors["P2"])
        Pf = ufloat(statistics.mean(self.data["P1"][-pressure_sampling_time:]), self.errors["P2"])
        Ti = ufloat(statistics.mean(self.data["T1"][temperature_sampling_start:(temperature_sampling_start + temperature_sampling_time)]), self.errors["T2"])
        Tf = ufloat(statistics.mean(self.data["T1"][-temperature_sampling_time:]), self.errors["T2"])
        ...
        print("Volue of container: ", self.vol * 1000, "L")

        self.mi = Pi * 6894.76 * self.vol / (R_air * Ti)
        print("initial mass of container: ", self.mi * 1000, " g")
        
        
    def plot_temp(self, title = "Modify title", subtitle = None, include_right = True):
    ...
    def plot_p(self, title = "Modify title", subtitle = None, include_right = True):
    ...
    def plot_p_other(self, other, title, subtitle = None, initial = 0, final = 0):
        plt.scatter(self.data["Time"], self.data["P1"], s=2, alpha=0.5, color = "r", label='Left tank, first experiment')
        plt.errorbar(self.data["Time"], self.data["P1"], xerr=0,  alpha=0.5, yerr=self.errors["P1"], ls = "None", color = "salmon", zorder=-1, label='Left tank error, first experiment')

        plt.scatter(self.data["Time"], self.data["P2"], s=2, alpha=0.5, color = "deepskyblue", label='Right tank, first experiment')
        plt.errorbar(self.data["Time"], self.data["P2"], xerr=0,  alpha=0.5, yerr=self.errors["P2"], ls = "None", color = "skyblue", zorder=-1, label='Right tank error, first experiment')

        plt.scatter(other.data["Time"], other.data["P1"], s=2, alpha=0.5, color = "coral", label='Left tank, second experiment')
        plt.errorbar(other.data["Time"], other.data["P1"], xerr=0,  alpha=0.5, yerr=self.errors["P1"], ls = "None", color = "tomato", zorder=-1, label='Left tank error, second experiment')

        plt.scatter(other.data["Time"], other.data["P2"], s=2, alpha=0.5, color = "teal", label='Right tank, second experiment')
        plt.errorbar(other.data["Time"], other.data["P2"], xerr=0,  alpha=0.5, yerr=other.errors["P2"], ls = "None", color = "darkcyan", zorder=-1, label='Right tank error, second experiment')


        plt.axhline(y = initial, color = 'purple', linestyle = 'dashed', label = "Initial pressure",  zorder=2)    
        plt.axhline(y = final, color = 'midnightblue', linestyle = 'dashed', label = "Final pressure",  zorder=2)   
    ...
    def plot_t_other(self, other, title, subtitle = None, initial = 0, final = 0):
        plt.scatter(self.data["Time"], self.data["T1"], s=2, alpha=0.5, color = "r", label='Left tank, first experiment')
        plt.errorbar(self.data["Time"], self.data["T1"], xerr=0,  alpha=0.5, yerr=self.errors["P1"], ls = "None", color = "salmon", zorder=-1, label='Left tank error, first experiment')

        plt.scatter(self.data["Time"], self.data["T2"], s=2, alpha=0.5, color = "deepskyblue", label='Right tank, first experiment')
        plt.errorbar(self.data["Time"], self.data["T2"], xerr=0,  alpha=0.5, yerr=self.errors["P2"], ls = "None", color = "skyblue", zorder=-1, label='Right tank error, first experiment')

        plt.scatter(other.data["Time"], other.data["T1"], s=2, alpha=0.5, color = "coral", label='Left tank, second experiment')
        plt.errorbar(other.data["Time"], other.data["T1"], xerr=0,  alpha=0.5, yerr=self.errors["P1"], ls = "None", color = "tomato", zorder=-1, label='Left tank error, second experiment')

        plt.scatter(other.data["Time"], other.data["T2"], s=2, alpha=0.5, color = "teal", label='Right tank, second experiment')
        plt.errorbar(other.data["Time"], other.data["T2"], xerr=0,  alpha=0.5, yerr=other.errors["P2"], ls = "None", color = "darkcyan", zorder=-1, label='Right tank error, second experiment')


        plt.axhline(y = initial, color = 'purple', linestyle = 'dashed', label = "Initial Temperature",  zorder=2)    
        plt.axhline(y = final, color = 'midnightblue', linestyle = 'dashed', label = "Final Temperature",  zorder=2)   
...
first.plot_p_other(second, "Pressure in both tanks over time", "both experiments", 16, 39)
first.plot_t_other(second, "Temperature in both tanks over time", "both experiments",298.5, 299.5)
...
# thrid.plot_p("Pressure in both tanks over time", "second experiment", False)
# thrid.plot_temp("Temperature in both tanks over time", "second experiment", False)
